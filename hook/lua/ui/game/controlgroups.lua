    ...
    local function CreateGroup(units, label)
        ...
        bg.UpdateGroup = function(self)
            ...
            if table.getsize(self.units) > 0 then
				...
				sortedUnits[2] = EntityCategoryFilterDown(categories.HERO, self.units)
				sortedUnits[3] = EntityCategoryFilterDown(categories.TITAN, self.units)
                sortedUnits[4] = EntityCategoryFilterDown(categories.EXPERIMENTAL, self.units)
				sortedUnits[5] = EntityCategoryFilterDown(categories.ELITE - categories.FACTORY, self.units)
                sortedUnits[6] = EntityCategoryFilterDown(categories.TECH3 - categories.FACTORY, self.units)
                sortedUnits[7] = EntityCategoryFilterDown(categories.TECH2 - categories.FACTORY, self.units)
                sortedUnits[8] = EntityCategoryFilterDown(categories.TECH1 - categories.FACTORY, self.units)
                sortedUnits[9] = EntityCategoryFilterDown(categories.FACTORY, self.units)

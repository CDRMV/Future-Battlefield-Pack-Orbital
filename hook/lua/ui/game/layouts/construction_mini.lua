...
function LayoutTabs(controls)
    ...
    local techFiles = {
		...
		t35 = '/mods/Future Battlefield Pack Orbital/icons/Techlevels/t35_btn_',
        t4 = '/game/construct-tech_btn/t4_btn_',
		t5 = '/mods/Future Battlefield Pack Orbital/icons/Techlevels/t5_btn_',
		t6 = '/mods/Future Battlefield Pack Orbital/icons/Techlevels/t6_btn_',

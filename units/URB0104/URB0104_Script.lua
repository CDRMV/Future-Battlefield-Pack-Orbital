...
URB0104 = Class(CStructureUnit) {   
    ...
    OpenState = State() {
        ...
        Main = function(self)            
            ...
            self.Trash:Add(CreateAttachedEmitter(self,'URC1301',army, '/effects/emitters/structure_steam_ambient_01_emit.bp'):OffsetEmitter(0, 0, 0))
            self.Trash:Add(CreateAttachedEmitter(self,'URC1301',army, '/effects/emitters/structure_steam_ambient_02_emit.bp'):OffsetEmitter(0, 0, 0))
            self.Trash:Add(CreateAttachedEmitter(self,'Attachpoint1',army, '/effects/emitters/light_red_rotator_01_emit.bp'):ScaleEmitter( 2.00 ))
            
            if newSat then
                self.Satellite = CreateUnitHPR('URFSP0100', self:GetArmy(), location[1], location[2], location[3], 0, 0, 0)
            ...
            WaitFor( self.AnimManip )
			self.Trash:Add(CreateAttachedEmitter(self,'URC1301',army, '/effects/emitters/uef_orbital_death_laser_launch_01_emit.bp'):OffsetEmitter(0.00, 0.00, 0.00))
			self.Trash:Add(CreateAttachedEmitter(self,'URC1301',army, '/effects/emitters/uef_orbital_death_laser_launch_02_emit.bp'):OffsetEmitter(0.00, 0.00, 0.00))
